...
public class FactionWarStats
{
	...
	public void AddDominationGameScore(long amount)
	{
		...
		FactionWarStats factionWarStat = this;
		factionWarStat.dominationGameScore = factionWarStat.dominationGameScore + amount;
		FactionWarStats factionWarStat1 = this;
		factionWarStat1.currentDayScore = factionWarStat1.currentDayScore + amount;
	}
	...
	public void AddExtractionScore(long amount)
	{
		...
		FactionWarStats factionWarStat = this;
		factionWarStat.extractionPointScore = factionWarStat.extractionPointScore + amount;
		FactionWarStats factionWarStat1 = this;
		factionWarStat1.currentDayScore = factionWarStat1.currentDayScore + amount;
	}
	...
	public void AddFuseScore(long amount)
	{
		...
		FactionWarStats factionWarStat = this;
		factionWarStat.fuseEquilibriumScore = factionWarStat.fuseEquilibriumScore + amount;
		FactionWarStats factionWarStat1 = this;
		factionWarStat1.currentDayScore = factionWarStat1.currentDayScore + amount;
	}
	...
	public void AddInstanceScore(long amount)
	{
		...
		FactionWarStats factionWarStat = this;
		factionWarStat.clearInstanceScore = factionWarStat.clearInstanceScore + amount;
		FactionWarStats factionWarStat1 = this;
		factionWarStat1.currentDayScore = factionWarStat1.currentDayScore + amount;
	}
	...
	public void AddKillPlayerScore(long amount)
	{
		...
		FactionWarStats factionWarStat = this;
		factionWarStat.killPlayerScore = factionWarStat.killPlayerScore + amount;
		FactionWarStats factionWarStat1 = this;
		factionWarStat1.currentDayScore = factionWarStat1.currentDayScore + amount;
	}
	...
	public void Donate(PlayerData plr, long donation)
	{
		...
		FactionWarStats factionWarStat = this;
		factionWarStat.treasury = factionWarStat.treasury + donation;
	}
