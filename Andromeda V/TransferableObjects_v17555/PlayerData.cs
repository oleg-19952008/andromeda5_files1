		...
		if (this.tcpClient != null)
		{
			if (this.tcpClient.Connected)
			{
				lock (this.bufferOut)
				{
					...
					int bytes = h.ToBytes(this.bufferOut, (int)this.outEndIndex) ;
					if ((long)bytes + this.outEndIndex + (long)200 <= (long)((int)this.bufferOut.Length))
					{
						...
						if (!this.isSenderWorking)
						{
							...
							{
								this.tcpClient.Client.BeginSend(this.bufferOut, this.outStartIndex, (int)this.outEndIndex - this.outStartIndex, SocketFlags.None, new AsyncCallback(this.SendCallback), this.tcpClient.Client);
                         //       this.tcpClient.Client.BeginSend(Encoding.UTF8.GetBytes(UdpCommHeader.data_), 0, 2048,  SocketFlags.None, new AsyncCallback(this.SendCallback), this.tcpClient.Client);
