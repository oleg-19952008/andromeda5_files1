...
public class PlayerBelongings : ITransferable
{
	...
	public ShipConfiguration BuildCfg(Guild guild)
	{
		...
		for (int k = 0; k < 6; k++)
		{
			...
			if (slotItemWeapon != null)
			{
				...
				{
					shipConfiguration.skillDamage += weaponSlot.skillDamage;
				}
				...
				{
					shipConfiguration.targetingForLaser += slotItemWeapon.TargetingTotal;
				}
				...
				{
					shipConfiguration.targetingForIon += slotItemWeapon.TargetingTotal;
				}
				else
				{
					shipConfiguration.targetingForPlasma += slotItemWeapon.TargetingTotal;
				}
	...
	public ShipConfiguration CalculateBonus(PlayerShipNet pShip, PlayerItems pItems)
	{
		...
		for (int i = 0; i < (int)slotItemArray.Length; i++)
		{
			...
			{
				bonusFive2 += (float)slotItem.BonusFive;
			}
			if (PlayerItems.IsExtraCargoMining(slotItem.ItemType))
			{
				bonusFour1 += (float)slotItem.BonusFive;
			}
			if (PlayerItems.IsExtraOther(slotItem.ItemType))
			{
				bonusFour1 += (float)slotItem.BonusFour;
			}
			if (PlayerItems.IsExtraCooldown(slotItem.ItemType))
			{
				bonusOne += (float)slotItem.BonusOne;
				bonusTwo += (float)slotItem.BonusTwo;
				bonusThree += (float)slotItem.BonusThree;
				bonusFour += slotItem.BonusFour;
				bonusFive += slotItem.BonusFive;
			}
			if (PlayerItems.IsExtraDamage(slotItem.ItemType))
			{
				bonusFour += slotItem.BonusThree;
				bonusFive += slotItem.BonusFour;
				bonusFive1 += slotItem.BonusFive;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraBasicCPUforShildRegen)
			{
				bonusFive2 += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraBasicCPUforShildRegen]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraAdvancedCPUforShildRegen)
			{
				bonusFive2 += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraAdvancedCPUforShildRegen]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraOverclockedCPUforShildRegen)
			{
				bonusFive2 += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraOverclockedCPUforShildRegen]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraCPUforShildRegen30)
			{
				bonusFive2 += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraCPUforShildRegen30]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraCPUforShildRegen40)
			{
				bonusFive2 += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraCPUforShildRegen40]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraCPUforShildRegen50)
			{
				bonusFive2 += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraCPUforShildRegen50]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraCPUforShildRegen60)
			{
				bonusFive2 += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraCPUforShildRegen60]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraCPUforShildRegen70)
			{
				bonusFive2 += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraCPUforShildRegen70]).efValue;
			}
			if ((slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsModule || slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsModule1 || slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsModule2 || slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsModule3 || slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsModule4 ? true : slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsModule5))
			{
				...
				powerUpEffectValue1 += (float)item;
			}
			...
			{
				item1 += ((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraLaserAimingCPU]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraPlasmaAimingCPU)
			{
				item2 += ((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraPlasmaAimingCPU]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraIonAimingCPU)
			{
				num2 += ((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraIonAimingCPU]).efValue;
			}
			...
			{
				bonusFour1 += (float)((ExtrasNet)StaticData.allTypes[slotItem.ItemType]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsCoolant)
			{
				bonusOne += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraLaserWeaponsCoolant]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsCoolant1)
			{
				bonusOne += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraLaserWeaponsCoolant1]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsCoolant2)
			{
				bonusOne += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraLaserWeaponsCoolant2]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsCoolant3)
			{
				bonusOne += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraLaserWeaponsCoolant3]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsCoolant4)
			{
				bonusOne += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraLaserWeaponsCoolant4]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraLaserWeaponsCoolant5)
			{
				bonusOne += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraLaserWeaponsCoolant5]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraPlasmaWeaponsCoolant)
			{
				bonusTwo += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraPlasmaWeaponsCoolant]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraPlasmaWeaponsCoolant1)
			{
				bonusTwo += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraPlasmaWeaponsCoolant1]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraPlasmaWeaponsCoolant2)
			{
				bonusTwo += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraPlasmaWeaponsCoolant2]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraPlasmaWeaponsCoolant3)
			{
				bonusTwo += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraPlasmaWeaponsCoolant3]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraPlasmaWeaponsCoolant4)
			{
				bonusTwo += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraPlasmaWeaponsCoolant4]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraPlasmaWeaponsCoolant5)
			{
				bonusTwo += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraPlasmaWeaponsCoolant5]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraIonWeaponsCoolant)
			{
				bonusThree += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraIonWeaponsCoolant]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraIonWeaponsCoolant1)
			{
				bonusThree += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraIonWeaponsCoolant1]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraIonWeaponsCoolant2)
			{
				bonusThree += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraIonWeaponsCoolant2]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraIonWeaponsCoolant3)
			{
				bonusThree += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraIonWeaponsCoolant3]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraIonWeaponsCoolant4)
			{
				bonusThree += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraIonWeaponsCoolant4]).efValue;
			}
			if (slotItem.ItemType == PlayerItems.TypeExtraIonWeaponsCoolant5)
			{
				bonusThree += (float)((ExtrasNet)StaticData.allTypes[PlayerItems.TypeExtraIonWeaponsCoolant5]).efValue;
			}
		...
		single5 += (float)pShip.guildResilience;
		single3 += (float)pShip.guildExpirience;
		if (this.HaveExperienceBooster)
		{
			single3 += 100f;
		}
		single3 += (float)this.factionWarXpBonus;
		...
		bonusFive2 += (float)(num + num1);
		if (this.HaveShieldPowerFlat)
		{
			bonusFive2 += (float)this.GetPowerUpEffectValue(PlayerItems.TypePowerUpForShieldPowerFlat);
		}
		...
		{
			bonusFour += this.GetPowerUpEffectValue(PlayerItems.TypePowerUpForLaserDamageFlat);
		}
		if (this.HaveLaserDamagePercentage)
		{
			powerUpEffectValue1 += (float)this.GetPowerUpEffectValue(PlayerItems.TypePowerUpForLaserDamagePercentage);
		}
		if (this.HavePlasmaDamageFlat)
		{
			bonusFive += this.GetPowerUpEffectValue(PlayerItems.TypePowerUpForPlasmaDamageFlat);
		}
		if (this.HavePlasmaDamagePercentage)
		{
			powerUpEffectValue2 += (float)this.GetPowerUpEffectValue(PlayerItems.TypePowerUpForPlasmaDamagePercentage);
		}
		if (this.HaveIonDamageFlat)
		{
			bonusFive1 += this.GetPowerUpEffectValue(PlayerItems.TypePowerUpForIonDamageFlat);
		}
		if (this.HaveIonDamagePercentage)
		{
			single2 += (float)this.GetPowerUpEffectValue(PlayerItems.TypePowerUpForIonDamagePercentage);
		}
		if (this.HaveTotalDamagePercentage)
		{
			powerUpEffectValue += (float)this.GetPowerUpEffectValue(PlayerItems.TypePowerUpForTotalDamagePercentage);
		}
	...
	public MakeSynthesisResult CreateAmmoFromMineral(ushort ammoKey, int packetsCount, out int equilibriumUsed, byte creatAmmoBonus = 0)
	{
		...
		if (num <= this.AllowedAmmo((int)ammoKey))
		{
			...
			foreach (ushort key_ in nums.Keys)
			{
				if (key == PlayerItems.TypeEquilibrium)
				{
					if ((long)(nums[key_] * packetsCount) > this.playerItems.Equilibrium)
					{
						makeSynthesisResult = MakeSynthesisResult.NotEnoughMinerals;
						return makeSynthesisResult;
					}
				}
				else if ((long)(nums[key_] * packetsCount) > this.playerItems.GetMinetalQty(key_))
				{
					makeSynthesisResult = MakeSynthesisResult.NotEnoughMinerals;
					return makeSynthesisResult;
				}
		...
		if (this.playerItems.Nova >= (long)PlayerObjectPhysics.TALENT_RETRAIN_PRICE)
		{
			...
			switch (skillTree)
			{
				case SkillType.Guardian:
				{
					...
					{
						amountAt += this.playerItems.GetAmountAt(n);
						this.playerItems.Set(n, (long)0);
				...
				case SkillType.Destroyer:
				{
					...
					{
						amountAt += this.playerItems.GetAmountAt(num1);
				...
				case SkillType.Protector:
				{
					...
					{
						amountAt += this.playerItems.GetAmountAt(num2);
				...
				case SkillType.Passive:
				{
					...
					{
						amountAt += this.playerItems.GetAmountAt(num3);
				...
				case SkillType.Amplification:
				{
					...
					{
						amountAt += this.playerItems.GetAmountAt(num4);
	...
	public void Serialize(BinaryWriter bw)
	{
		...
		if (this.playerQuests != null)
		{
			...
			foreach (int ii in this.playerQuests.Keys)
			{
				bw.Write(i);
				this.playerQuests[ii].Serialize(bw);
			}
		}
		else
		{
